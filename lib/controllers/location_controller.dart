...
class LocationController extends GetxController {
  ...
  void setPolylines() async {
    ...
    double stopLatitude = routesList[_storageController.routeIndex.value]
        .stops[_storageController.stopIndex.value]
        .latitude;
    double stopLongitude = routesList[_storageController.routeIndex.value]
        .stops[_storageController.stopIndex.value]
        .longitude;
    PolylineResult polylineResult =
        await polylinePoints.getRouteBetweenCoordinates(
      "AIzaSyDoRgE30RtaLlabF3uJpk28EfndoBmZwwg",
